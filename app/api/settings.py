...
async def get_settings(pool: asyncpg.Pool = Depends(get_db)):
    ...
    return {
        ...
        "data": {
            ...
            "m1_telegram_fired_per_minute_cap": app_settings.M1_TELEGRAM_FIRED_PER_MINUTE_CAP,
            "m1_telegram_confirm_per_minute_cap": app_settings.M1_TELEGRAM_CONFIRM_PER_MINUTE_CAP,
